    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.PositiveIntegerField(default=0, help_text=b'The price of the product in positive integers')),
                ('actual_price', models.PositiveIntegerField(help_text=b'The actual price of the product')),
                ('discount_percent', models.PositiveIntegerField(help_text=b'Percentage of discount provided')),
